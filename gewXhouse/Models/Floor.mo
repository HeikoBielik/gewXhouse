...
model Floor
  parameter Modelica.Blocks.Interfaces.RealInput w = 0.1 "m floor width" annotation(
  ...
  parameter Modelica.Blocks.Interfaces.RealInput rho = 0.001 "g/cm3 density" annotation(
  ...
  parameter gewXhouse.Connectors.Interfaces.HeatFluxInput I_Intern = 1000 annotation(
  ...
  parameter Modelica.Blocks.Interfaces.RealInput surface = 15 "Ground floor" annotation(
...
equation
  ...
  connect(product.u1, surface) annotation(
    Line(points = {{-48, 62}, {-69, 62}, {-69, 62}, {-96, 62}}, color = {0, 0, 127}));
  connect(w, product.u2) annotation(
    Line(points = {{-70, 50}, {-60, 50}, {-60, 50}, {-50, 50}, {-50, 50}, {-49, 50}, {-49, 50}, {-48, 50}}, color = {0, 0, 127}));
  connect(heatCapacitor.volume, product.y) annotation(
    Line(points = {{-16, 44}, {-19, 44}, {-19, 44}, {-22, 44}, {-22, 56}, {-25, 56}}, color = {0, 0, 127}));
