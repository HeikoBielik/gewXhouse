...
equation
  ...
  annotation(
    ...
    Documentation(info = "<html><head></head><body><p><b>FLOOR MODEL</b></p><p>The floor model is an important part of the greenhouse model. The short wave radiation from the sun, which will be transfered through the cover to the floor turns into long wave radiation in the floor. The floor is the main \"capacity\" in the greenhouse. Through the radiation of the sun the floors gets warmer and transfers the heat to enviroment air. The user has the possiblity to enter different materials with the material specific variables. Those parameter can be changed in the&nbsp;<a href=\"modelica://gewXhouse.Models.House\" style=\"font-size: 12px;\">house</a>&nbsp;model.</p><p>In the floor are interacting following modelica standard components, which has been adapted to the greenhouse:</p><p></p><ul><li><a href=\"modelica://gewXhouse.Models.HeatCapacitor\">heat capacitor</a></li><li><a href=\"modelica://gewXhouse.Models.Radiation\">radiation</a></li><li><a href=\"modelica://gewXhouse.Models.ThermalConductor\" style=\"font-size: 12px;\">thermal conductor</a></li><li><a href=\"modelica://Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a\" style=\"font-size: 12px;\">heat port</a></li></ul><div>The heatCapacitor represents the heat capacitor of the floor. This capacity is connected to the thermal conducters and the radiation via the heat ports.&nbsp;</div><div><br></div><div>The thermal conductors has three inputs: two temperatures inputs to calcute a difference and constant thermal conductance of a material. The conductors returns a heat flux (Q_Flow) and is connected to the capacity. In the floor model are two conductors:</div><div>1. exchange between air and house floor&nbsp;</div><div>2. exchange between house floor and enviroment floor</div><div><br></div><div>Through the connector the solar radiation heats up the capacity of the floor.&nbsp;</div><div><br></div><div>The total floor capacity will be calculated in heat capacitor model.</div></body></html>"));
end Floor;
