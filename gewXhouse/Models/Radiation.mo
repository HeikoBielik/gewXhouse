...
model Radiation
  ...
  Modelica.Blocks.Interfaces.RealInput S annotation(Placement(visible = true, transformation(origin = {60, 120},extent = {{-20,-20}, {20, 20}}, rotation = -90), iconTransformation(origin = {-28, -80},extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  parameter gewXhouse.Connectors.Interfaces.HeatFluxInput I = 1000 annotation(Placement(visible = true, transformation(origin = {-20, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-28, 0}, extent = {{-20, -20}, {20,20}}, rotation = 0)));
equation
  port.Q_flow = I * S;
  annotation (
