...
equation
  ...
  Documentation(info = "<html><head></head><body><p><b>AIR MODEL</b></p><p>The air model is a component in the greenhouse, which interact with all components in the greenhouse and influence each other. The user is able to change the medium in the<span style=\"font-size: 12px;\">&nbsp;</span><a href=\"modelica://gewXhouse.Models.House\" style=\"font-size: 12px;\">house</a>&nbsp;model.</p><p>The capacity of the air is calculated in this model (material specific parameters) and the resulting temperatures is transfered via  <a href=\"modelica://Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a\" style=\"font-size: 12px;\">heat port</a>.</p></body></html>"));
end Air;
