...
equation
  ...
  Documentation(info = "<html><head></head><body><p><b>ENVIRONMENT MODEL</b></p><p><!--StartFragment-->The environment model gives the ability to connect themperature course files of the outside air and floor. To observe the influence of a heatflux from the inner floor directly to the outer environment the outside floor temperature course file can be switched on and off.<!--EndFragment--></p><p>Overview of environment input/output&nbsp;</p>
