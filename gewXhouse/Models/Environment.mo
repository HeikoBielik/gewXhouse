...
model Environment
  ...
  constant Modelica.SIunits.Temperature T = 300     "Temperature outside";
  gewXhouse.Connectors.heat_flow Wall annotation(
    Placement(visible = true, transformation(origin = {-60, 0}, extent = {{-50, -50}, {50, 50}}, rotation = 0), iconTransformation(origin = {-60, 0}, extent = {{-50, -50}, {50, 50}}, rotation = 0)));

equation

  Wall.Q = S * Wall.w * Wall.dT / Wall.d;
  Wall.dT=der(T);
