...
model Environment
  ...
  fileName = "C:/Users/m.jilg.LOCCIONI/Documents/OpenModelica/Projekte/gewXhouse/gewXhouse/Resources/temp.txt", 
  offset = {0}, 
  smoothness = Modelica.Blocks.Types.Smoothness.LinearSegments, 
  startTime = 1, table = fill(0.0, 0, 2), 
  tableName = "temp", 
  tableOnFile = true, 
  timeScale = 60, 
  ...
  gewXhouse.Connectors.environment environment annotation(
    Placement(visible = true, transformation(origin = {30, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {80, -3.55271e-15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Thermal.HeatTransfer.Celsius.ToKelvin toKelvin annotation(
    Placement(visible = true, transformation(origin = {-10, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
algorithm
environment.T := toKelvin.Kelvin;
  equation
  connect(toKelvin.Celsius, temperature.y[1]) annotation(
    Line(points = {{-22, 10}, {-40, 10}, {-40, 10}, {-38, 10}}, color = {0, 0, 127}));
  annotation(
