...
model Greenhouse
  ...
  gewXhouse.Models.Greenhouse.surface_south surface_south1 annotation(
    Placement(visible = true, transformation(origin = {-1.04361e-14, -1.04361e-14}, extent = {{-100, -100}, {100, 100}}, rotation = 0)));
  gewXhouse.Models.Greenhouse.surface_north surface_north1 annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-100, -100}, {100, 100}}, rotation = 0)));
  gewXhouse.Models.Greenhouse.surcafe_east surcafe_east1 annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-100, -100}, {100, 100}}, rotation = 0)));
  gewXhouse.Models.Greenhouse.surface_west surface_west1 annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-100, -100}, {100, 100}}, rotation = 0)));
  gewXhouse.Models.Greenhouse.surface_roof_east surface_roof_east1 annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-100, -100}, {100, 100}}, rotation = 0)));
  gewXhouse.Models.Greenhouse.surface_roof_west surface_roof_west1 annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-100, -100}, {100, 100}}, rotation = 0)));
