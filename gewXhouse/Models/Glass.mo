...
equation
  ...
  Documentation(info = "<html><head></head><body><div><b>GLASS MODEL</b></div><div><br></div>The glass model is able to simulate a double glazing (glass 1 and glass 2) model with a gas between it. Therefore this model includs different modelica standard blocks e.g.&nbsp;<a href=\"modelica://Modelica.Blocks.Math.Product\">product</a>,&nbsp;<a href=\"modelica://Modelica.Thermal.HeatTransfer.Components.HeatCapacitor\" style=\"font-size: 12px;\">heat capacity</a>,&nbsp;<a href=\"modelica://Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a\" style=\"font-size: 12px;\">heat port</a>, which were adapted to the glass model.The user is able to chagne&nbsp;glass width or the gas gap with desired gas like krypton or xenon.&nbsp;<div><br></div></body></html>"));
end Glass;
