...
equation
  ...
  Documentation(info = "<html><head></head><body><div><b>GLASS MODEL</b></div><div><br></div><!--StartFragment--><span style=\"font-size: 12px;\">The glass model is able to simulate insulated glass (glass 1 and glass 2 with insulating gas inbetween). Therefore this model includes different modelica standard blocks e.g.&nbsp;</span><a href=\"modelica:///Modelica.Blocks.Math.Product\" style=\"font-size: 12px;\">product</a><span style=\"font-size: 12px;\">,&nbsp;</span><a href=\"modelica:///Modelica.Thermal.HeatTransfer.Components.HeatCapacitor\" style=\"font-size: 12px;\">heat capacity</a><span style=\"font-size: 12px;\">,&nbsp;</span><a href=\"modelica:///Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a\" style=\"font-size: 12px;\">heat port</a><span style=\"font-size: 12px;\">, which were adapted to the glass model.The user is able to change the glass and gap width also different gas types can be simulated by adjusting the corresponding thermal conductivity coefficients.&nbsp;</span><!--EndFragment--><br><div><br></div></body></html>"));
end Glass;
