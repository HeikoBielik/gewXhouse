...
model House
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b out annotation(
  ...
  gewXhouse.Models.Cover cover(w.y=cover_w, l.y=cover_l, rho.y= cover_rho, c_p.y=cover_c_p, N=N, surfacesPitch=surfacesPitch, surfacesNorth=surfacesNorth) annotation(
